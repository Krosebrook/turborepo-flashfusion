...
class ConfigManager {
  ...
  validate() {
    ...
    const requiredConfigs = ['app.environment', 'app.port'];
    ...
    if (dbType === 'supabase') {
      if (
        !this.get('database.supabase.url') ||
        !this.get('database.supabase.anonKey')
      ) {
        errors.push('Supabase URL and anonymous key are required');
      }
    } else if (dbType === 'postgresql') {
      if (
        !this.get('database.postgresql.url') &&
        !this.get('database.postgresql.host')
      ) {
  ...
  getConnectionString(dbType = null) {
    ...
    if (type === 'postgresql') {
      return (
        this.get('database.postgresql.url') ||
        this.buildPostgreSQLConnectionString()
      );
    }
