            ...
            try {
                ...
                if (useSearch || !this.token) {
                    ...
                    if (repos && repos.length > 0) {
                        ...
                        if (repos.length < (options.per_page || 100) || repositories.length >= result.total_count) {
                            hasMore = false;
                        }
                    } else {
                        hasMore = false;
                ...
                if (!useSearch && (error.message.includes('403') || error.message.includes('401'))) {
        ...
        try {
            ...
            return {
                ...
                summary: {
                    ...
                    languages: [...new Set(transformedRepos.map(r => r.primary_language))].filter(l => l !== 'Unknown'),
